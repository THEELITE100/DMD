...
export default function ArtAndCulture() {
  ...
  const elements = [
    { title: "The Human Waterfall", desc: "A 4-story kinetic installation driving millions of organic social media impressions annually.", img: "/assets/art-waterfall.png", delay: 0 },
